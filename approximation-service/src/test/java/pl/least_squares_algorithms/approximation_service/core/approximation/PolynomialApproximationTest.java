package pl.least_squares_algorithms.approximation_service.core.approximation;
...
class PolynomialApproximationTest {
    ...
    void doApproximations() {
        ...
        resultPolynomial = polynomialApproximation.doApproximations(LeastSquaresMethod.NORMALIZATION).getFirst().polynomial();
